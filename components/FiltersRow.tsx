...
export default function FiltersRow({ activeEstado, activePrioridad, searchQuery, onEstadoChange, onPrioridadChange, onSearchChange }: FiltersRowProps) {
  ...
  return (
    <div className="flex items-center flex-wrap gap-2 mb-5">
      ...
      {/* Separator */}
      <div className="w-px h-[18px] bg-tk-border mx-1 flex-shrink-0" />
      ...
      <div className="ml-auto relative flex items-center">
        ...
        <input
          ...
          className="search-input w-[220px] pl-[30px] pr-2.5 py-[6px] bg-tk-bg3 border border-tk-border rounded text-tk-text font-mono text-xs tracking-[0.02em] transition-[border-color,background] duration-[0.15s]"
        />
      </div>
    </div>
  );
